...
- For concrete folder layout and extraction thresholds, read [.cursor/skills/plugin-architecture/references/folder-structure.md](.cursor/skills/plugin-architecture/references/folder-structure.md).
