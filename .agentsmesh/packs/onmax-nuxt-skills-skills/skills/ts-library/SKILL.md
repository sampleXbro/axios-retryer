...
- [ ] [references/build-tooling.md](references/build-tooling.md) - if configuring Rollup, tsdown, unbuild, or build scripts
...
3. Configure `package.json` exports → load [references/package-exports.md](references/package-exports.md)
4. Set up build with Rollup by default → load [references/build-tooling.md](references/build-tooling.md)
...
6. Add package-contract tests and clean-consumer checks → load [references/testing.md](references/testing.md)
7. Configure release → load [references/release.md](references/release.md)
