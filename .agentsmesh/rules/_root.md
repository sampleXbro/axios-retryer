...
The core exists _only_ to perform Inversion of Control (IoC). It orchestrates dependencies.
...
- Write the unit test _before_ or alongside the implementation.
...
_If you understand these rules, proceed with your task, prioritizing systemic health above ticket closure speed._
