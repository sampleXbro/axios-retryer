...
export interface SanitizeOptions {
  ...
  /**
   * Explicit list of payload field names that may remain visible in logs.
  ...
  /**
   * When true, payload values are redacted by default unless their field name
   * is present in allowedFields.
   *
   * @default true
   */
