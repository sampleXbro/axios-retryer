...
- For concrete folder layout and extraction thresholds, read [.agents/skills/plugin-architecture/references/folder-structure.md](.agents/skills/plugin-architecture/references/folder-structure.md).
