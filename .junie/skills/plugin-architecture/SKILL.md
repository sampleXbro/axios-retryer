...
- For concrete folder layout and extraction thresholds, read [.junie/skills/plugin-architecture/references/folder-structure.md](.junie/skills/plugin-architecture/references/folder-structure.md).
